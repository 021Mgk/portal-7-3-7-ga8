...
package mgkportlet.search.contributor.sort;
...
@Component(
	immediate = true,
	property = ContributorConstants.ENTRY_CLASS_NAME_PROPERTY_KEY + "=mgkportlet.model.Person",
	service = SortFieldNameTranslator.class
)
public class PersonSortFieldNameTranslator implements SortFieldNameTranslator {
